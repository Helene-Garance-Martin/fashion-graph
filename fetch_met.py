...
DESIGNERS = {
    ...
    "McCardell":     ["McCardell"],         # Claire McCardell
    "Charles James": ["Charles James"],     # the American couturier
    "Schiaparelli":  ["Schiaparelli"],      # Elsa Schiaparelli + House of Schiaparelli
    "Balenciaga":    ["Balenciaga"],        # Cristóbal Balenciaga
}
